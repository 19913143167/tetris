...
public class AboutAuthorDialog extends JDialog {
	...
	public AboutAuthorDialog(Frame owner, boolean modal) {
		...
		lblAuthor.setBounds(10, 10, 60, 15);
		getContentPane().add(lblAuthor);
		
		final JTextField txtAuthor = new JTextField();
		txtAuthor.setText("zhaohuihua");
		txtAuthor.setBounds(40, 31, 150, 21);
		...
		lblEmail.setBounds(10, 58, 60, 15);
		getContentPane().add(lblEmail);
		
		final JTextField txtEmail = new JTextField();
		txtEmail.setText("zhaohuihua@126.com");
		txtEmail.setBounds(40, 79, 150, 21);
