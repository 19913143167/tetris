...
import zhh.game.tetris.listenerinstance.ReadOnlyListener;
...
public class AboutGameDialog extends JDialog {
	...
	public AboutGameDialog(Frame owner, boolean modal) {
		...
		StyleConstants.setFontFamily(blueBold, "宋体");
		// 粗体蓝色风格
		...
		try {
			...
			String about = "俄罗斯方块游戏\n\n";
				doc.insertString(doc.getLength(), about, blueBold);
			about = "游戏简介：\n";
			doc.insertString(doc.getLength(), about, blue);
			about = new StringBuffer()
				...
				.append("\n")
				.toString();
			doc.insertString(doc.getLength(), about, null);
			about = "玩法简介：\n";
			doc.insertString(doc.getLength(), about, blue);
			about = new StringBuffer()
		...
		scrollPane.setBounds(10, 10, 194, 209);
		...
		separator.setBounds(10, 225, 194, 2);
